...
class stealCommand extends Command {
    constructor() {
        super('steal', {
            aliases: ['steal', 'yoink'],
            description: {
                content: 'Upload an emote from a link or external emote.',
                usage: '.steal < Emote or Link > < OPTIONAL if Emote is provided: Name >',
                examples: '.steal https://cdn.discordapp.com/emojis/774556339145146368.gif loader'
            },
